                        ...
                        <div class="">
                            <form action='transfer' method="get">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="s_name" value="<%=uname%>" placeholder="" readonly />
                                    <input type="hidden" value="<%=uname%>"/>
                                </div>
                                <div>
                                    <label>Your Account no</label>
                                    <input type="text" name="s_acc" value="<%=account_no%>" placeholder="" readonly />
                                    <input type="hidden" value="<%=uname%>"/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="sr_name" value="" placeholder="" required />
                                </div>
                                <div>
                                    <label>Reciever Account no</label>
                                    <input type="text" name="sr_acc" value="" placeholder="" required />
                                ...
                                <div>
                                    ...
                                    <input type="text" name="operation"  value="fund transfer"  placeholder=""  required/>
